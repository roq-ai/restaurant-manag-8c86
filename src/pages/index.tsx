  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Manager - Streamlining Your Business Operations with Our Comprehensive and User-Friendly SaaS Solution for Restaurant Management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Manager - Streamlining Your Business Operations with Our Comprehensive and User-Friendly SaaS Solution for Restaurant Management.`}
            </Text>
            <Box
